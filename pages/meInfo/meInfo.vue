<template>
	<view class="page page-fill">
		...
		<view class="page-block info-list" v-for="user in globalUser">
			<!-- 头像 --> 
			...
			<!-- 昵称 -->
			<view class="item-wapper" @click="modifyNickname" v-for="user in globalUser">
			...
			<!-- 生日 -->
			<view class="item-wapper" @click="modifyBirthday" v-for="user in globalUser">
			...
			<!-- 性别 -->
			<view class="item-wapper" @click="modifySex" v-for="user in globalUser">
				<view class="info-words">性别</view>
				
				<view class="right-wapper">
					<view class="gray-fields">
						
						<view v-if="user.sex == 1">
							男
						</view>
						<view v-else-if="user.sex == 0">
							女
						</view>
						<view v-else>
							未选择
